...
import { IReview } from "@/server/models/room";
...
const RoomReviews = () => {
  ...
  const getRoomReviewsHandler = () => {
    getRoomReviews(roomId);  //use rtk query,    getroomreview mutaion for this room id
  };
        ...
        <div className="col-6">
          <div className="form-check">
            ...
            <input
              ...
              value={roomId}
              onChange={(e) => setRoomId(e.target.value)}  //is room id ke reviews chaihe
            />
